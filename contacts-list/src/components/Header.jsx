        ...
        <Disclosure as="nav" className="bg-gray-800/50">
          <div className="mx-auto max-w-9xl px-4 sm:px-6 lg:px-8">
            <div className="flex h-16 items-center justify-between">
              ...
              <Input type="text" placeholder="Search" name="full_name" className="block rounded-md bg-white/5 px-3.5 py-2 text-base text-white outline-1 -outline-offset-1 outline-white/10 placeholder:text-gray-500 focus:outline-1 focus:-outline-offset-1 focus:outline-indigo-700 w-150" />
